...
* The WiringAutoencoderV2 model is imported from wae.model; the benchmark
  adapts its latent dim / tau_modes to each dataset's feature dimension.
* All 7 metrics are called through wae.metrics public functions; nothing
