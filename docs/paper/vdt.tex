...
drawn from a taumode variational prior.
This loading matrix parametrises a differentiable Laplacian $\Lmat(\mathbf{z})$
over which a heat-kernel \emph{taumode diffusion} decoder reconstructs the input.
...
\begin{table}[ht]
  ...
  \begin{tabular}{lll}
    ...
    taumode KL & $\mathrm{KL}_\tau$ & Frequency band selection \\
