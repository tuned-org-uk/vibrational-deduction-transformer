...
entries of $\Wmat \in \R^{d \times q}$ can be positive or negative,
...
base-graph weight.  Since $\|\Wmat_i - \Wmat_j\|^2 \geq 0$ by definition,
$\sigma(-\|\Wmat_i - \Wmat_j\|^2) \in (0, 0.5]$, so all edge weights are
\emph{strictly positive} and lie in $(0,\, w_{ij}^{\text{base}}/2]$.
