...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{\textwidth}
    \centering
    \includegraphics[width=0.72\textwidth]{../../docs/second-run-logs/training_curves.png}
    \caption*{Run 2: \texttt{lam\_s=0.1}, $q=8$, 45 epochs}
  \end{subfigure}
  \vspace{0.5em}
  \begin{subfigure}[t]{\textwidth}
    \centering
    \includegraphics[width=0.72\textwidth]{../../docs/third-run-logs/training_curves.png}
    \caption*{Run 3: \texttt{lam\_s=1.0}, $q=8$, \texttt{kl\_z\_warmup=10}, 45 epochs}
  \end{subfigure}
  \vspace{0.5em}
  \begin{subfigure}[t]{\textwidth}
    \centering
    \includegraphics[width=0.72\textwidth]{../../docs/fourth-run-logs/training_curves.png}
    \caption*{Run 4: \texttt{lam\_s=0.2}, $q=4$, \texttt{kl\_z\_warmup=25}, 50 epochs}
  \end{subfigure}
