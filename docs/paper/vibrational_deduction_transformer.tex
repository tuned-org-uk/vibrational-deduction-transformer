...
WAE used a hard high-frequency energy penalty
...
structure} that organises them.  The WAE
...
The VDT addresses all three limitations by embedding the WAE
...
The WAE trains a differentiable Laplacian $L(\bz)$ whose
...
Three limitations of the WAE motivate VDT:
